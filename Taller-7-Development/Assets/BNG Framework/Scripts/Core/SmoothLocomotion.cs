...
namespace BNG {
    ...
    public class SmoothLocomotion : MonoBehaviour {
        ...
        [SerializeField] PuzzlelManager puzzleManager;
        [SerializeField] bool necesitaVisionEco;
        ...
        public virtual void CheckControllerReferences() {
            ...
            if (ecovision == null && necesitaVisionEco)
            {
        ...
        public virtual void MoveCharacter() {
            ...
            if (necesitaVisionEco)
            {
                if (moveDirection != Vector3.zero && !puzzleManager.juegoCompletado)
                {
                    MoveCharacter(moveDirection * Time.deltaTime);
                    ecovision.VisiondePasos();
                }
            }
            else
            {
